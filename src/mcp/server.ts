  ...
  const server = new McpServer(
    { name: 'rm-brain', version: '0.1.0' },
    {
      instructions: [
        ...
        'When the user asks about a date, search the LITERAL digits they likely wrote by hand',
        '(e.g. "08/07", "8/7") as well as natural-language forms ("July 8") — notes rarely spell',
        'dates out. If one search comes back empty, try get_open_loops and broader keywords before',
